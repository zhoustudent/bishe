...
router.get('/lesson-js.html', function (req, res) {

    addlesson.find({lessondeviation:'javascript'}).exec( function (err, data) {
        if (!err) {
            // console.log(data)
            var lengths = data.length
            res.render('lesson-js', {
                title: 'CSS专区',
                datas:data,
                length:lengths
...
router.get('/lesson-js/:videoId',function(req,res){
...
router.post('/lesson-js/show',function(req,res){
...
router.post('/lesson-js/addshopcar',function(req,res){
