...
router.get('/lesson-css.html', function (req, res) {

    addlesson.find({lessondeviation:'CSS'}).exec( function (err, data) {
        if (!err) {
            // console.log(data)
            var lengths = data.length
            res.render('lesson-css', {
                title: 'CSS专区',
                datas:data,
                length:lengths
...
router.get('/lesson-css/:videoId',function(req,res){
...
router.post('/lesson-css/show',function(req,res){
...
router.post('/lesson-css/addshopcar',function(req,res){
