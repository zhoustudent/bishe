...
router.get('/lesson-vue.html', function (req, res) {

    addlesson.find({lessondeviation:'框架'}).exec( function (err, data) {
        if (!err) {
            // console.log(data)
            var lengths = data.length
            res.render('lesson-vue', {
                title: '框架专区',
                datas:data,
                length:lengths
...
router.get('/lesson-vue/:videoId',function(req,res){
...
router.post('/lesson-vue/show',function(req,res){
...
router.post('/lesson-vue/addshopcar',function(req,res){
